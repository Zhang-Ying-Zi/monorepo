...
class RxJsStore {
    constructor(reducer, initialState) {
        ...
        this.asyncDispatch = (type, runner) => __awaiter(this, void 0, void 0, function* () {
            const payload = yield runner(this._state.getValue());
    ...
    select(key) {
        return this._state.pipe((0, rxjs_1.distinctUntilKeyChanged)(key), (0, rxjs_1.map)(x => x[key]));
    }
    subscribe(callback) {
        return this._state.subscribe(callback);
    }
}
exports.RxJsStore = RxJsStore;
