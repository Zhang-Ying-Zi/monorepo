...
var _doc = (_gsScope.document || {}).documentElement,
    ...
    var rect = _unwrapElement(element).getBoundingClientRect(),
      ...
      cRect = isRoot
        ? {
            top:
              _doc.clientTop -
              (window.pageYOffset || _doc.scrollTop || b.scrollTop || 0),
            left:
              _doc.clientLeft -
              (window.pageXOffset || _doc.scrollLeft || b.scrollLeft || 0),
          }
  ...
  _parseVal = function (value, target, axis, currentVal) {
    ...
    return !isNaN(value)
      ...
      ? parseInt(value.charAt(0) + "1", 10) * parseFloat(value.substr(2)) +
        currentVal
      : value === "max"
      ? _max(target, axis)
    ...
    init: function (target, value, tween) {
      ...
      if (value.x != null) {
        this._addTween(
          ...
          "x",
          this.x,
          _parseVal(value.x, target, "x", this.x) - (value.offsetX || 0),
          "scrollTo_x",
          true
        );
      ...
      if (value.y != null) {
        this._addTween(
          ...
          "y",
          this.y,
          _parseVal(value.y, target, "y", this.y) - (value.offsetY || 0),
          "scrollTo_y",
          true
        );
