...
twosegments2.prototype.run = function () {
  ...
  function drawFrame() {
    ...
    segment1.set$rotation(
      segment0.get$rotation() +
        $mul(slider1.get$value(), 3.141592653589793) / 180
    );
...
Slider.prototype.get$onchange = function () {
  return this.onchange;
};
Slider.prototype.set$onchange = function (value) {
