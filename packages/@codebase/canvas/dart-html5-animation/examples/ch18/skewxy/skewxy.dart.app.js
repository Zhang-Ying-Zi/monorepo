...
$dynamic("transform$6").CanvasRenderingContext2D = function (
  $0,
  $1,
  $2,
  $3,
...
CanvasRenderingContext2DWrappingImplementation.prototype.transform = function (
  m11,
  m12,
  m21,
  m22,
...
CanvasRenderingContext2DWrappingImplementation.prototype.transform$6 =
  CanvasRenderingContext2DWrappingImplementation.prototype.transform;
...
skewxy.prototype.run = function () {
  ...
  function drawFrame(t) {
    ...
    var skewX = $sub(mouse.get$x(), canvas.get$width() / 2) * 0.01,
      skewY = $sub(mouse.get$y(), canvas.get$height() / 2) * 0.01,
      dx = canvas.get$width() / 2,
      dy = canvas.get$height() / 2;
    context.save();
