...
rotatexy.prototype.run = function () {
  ...
  function matrixMultiply(matrixA, matrixB) {
    var result = [];
    result.add$1(
      $mul(matrixA.$index(0), matrixB.$index(0).$index(0)) +
        $mul(matrixA.$index(1), matrixB.$index(1).$index(0)) +
        $mul(matrixA.$index(2), matrixB.$index(2).$index(0))
    );
    result.add$1(
      $mul(matrixA.$index(0), matrixB.$index(0).$index(1)) +
        $mul(matrixA.$index(1), matrixB.$index(1).$index(1)) +
        $mul(matrixA.$index(2), matrixB.$index(2).$index(1))
    );
    result.add$1(
      $mul(matrixA.$index(0), matrixB.$index(0).$index(2)) +
        $mul(matrixA.$index(1), matrixB.$index(1).$index(2)) +
        $mul(matrixA.$index(2), matrixB.$index(2).$index(2))
    );
    return result;
  }
  function rotateX(ball, angle) {
    var position = [ball.get$xpos(), ball.get$ypos(), ball.get$zpos()],
      sin = Math.sin(angle),
      cos = Math.cos(angle),
      xRotMatrix = [];
