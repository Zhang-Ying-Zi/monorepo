...
collision3d.prototype.run = function () {
  ...
  function checkCollision(ballA, i) {
    for (
      var ballB, dx, dy, dz, dist, j = $add(i, 1);
      $lt(j, numBalls);
      j = $add(j, 1)
    ) {
      ballB = balls.$index(j);
...
function Ball3d() {}
Ball3d.prototype.get$color = function () {
  return this.color;
};
Ball3d.prototype.set$color = function (value) {
  return (this.color = value);
};
Ball3d.prototype.get$radius = function () {
  return this.radius;
};
Ball3d.prototype.set$radius = function (value) {
