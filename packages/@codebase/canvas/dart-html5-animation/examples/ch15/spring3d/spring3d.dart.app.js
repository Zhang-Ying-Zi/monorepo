...
spring3d.prototype.run = function () {
  ...
  function drawFrame(t) {
    ...
    var dx = $sub(tx, ball.get$xpos()),
      dy = $sub(ty, ball.get$ypos()),
      dz = $sub(tz, ball.get$zpos());
...
Ball3d.prototype.get$vx = function () {
  return this.vx;
};
Ball3d.prototype.set$vx = function (value) {
  return (this.vx = value);
};
Ball3d.prototype.get$vy = function () {
  return this.vy;
};
Ball3d.prototype.set$vy = function (value) {
  return (this.vy = value);
};
Ball3d.prototype.get$vz = function () {
  return this.vz;
};
Ball3d.prototype.set$vz = function (value) {
