...
Ball.prototype.get$scaleX = function () {
  return this.scaleX;
};
Ball.prototype.set$scaleX = function (value) {
  return (this.scaleX = value);
};
Ball.prototype.get$scaleY = function () {
  return this.scaleY;
};
Ball.prototype.set$scaleY = function (value) {
...
Ball.prototype.get$visible = function () {
  return this.visible;
};
Ball.prototype.set$visible = function (value) {
...
(function () {
  ...
  var v3 /*UIEvent*/ =
    "UIEvent|CompositionEvent|KeyboardEvent|MouseEvent|SVGZoomEvent|TextEvent|TouchEvent|WheelEvent";
