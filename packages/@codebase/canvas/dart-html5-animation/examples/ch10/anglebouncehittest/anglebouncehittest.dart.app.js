...
Utils.intersects = function (rectA, rectB) {
  return !(
    $lt($add(rectA.get$x(), rectA.get$width()), rectB.get$x()) ||
    $lt($add(rectB.get$x(), rectB.get$width()), rectA.get$x()) ||
    $lt($add(rectA.get$y(), rectA.get$height()), rectB.get$y()) ||
    $lt($add(rectB.get$y(), rectB.get$height()), rectA.get$y())
  );
};
...
anglebouncehittest.prototype.run = function () {
  ...
  function drawFrame(t) {
    ...
    line.set$rotation(
      ($sub(canvas.get$width() / 2, mouse.get$x()) * 0.1 * 3.141592653589793) /
        180
    );
    ...
    if (Utils.intersects(ball.getBounds(), line.getBounds())) {
      var cos = Math.cos(line.get$rotation()),
        sin = Math.sin(line.get$rotation()),
        x1 = $sub(ball.get$x(), line.get$x()),
        y1 = $sub(ball.get$y(), line.get$y()),
        y2 = $mul(cos, y1) - $mul(sin, x1);
      if ($gt(y2, -ball.get$radius())) {
        var x2 = $mul(cos, x1) + $mul(sin, y1),
          vx1 = $mul(cos, ball.get$vx()) + $mul(sin, ball.get$vy()),
          vy1 = $mul(cos, ball.get$vy()) - $mul(sin, ball.get$vx());
        y2 = -ball.get$radius();
        vy1 = $mul(vy1, bounce);
...
Ball.prototype.get$x = function () {
  return this.x;
};
Ball.prototype.set$x = function (value) {
  return (this.x = value);
};
Ball.prototype.get$y = function () {
  return this.y;
};
Ball.prototype.set$y = function (value) {
  return (this.y = value);
};
Ball.prototype.get$vx = function () {
  return this.vx;
};
Ball.prototype.set$vx = function (value) {
  return (this.vx = value);
};
Ball.prototype.get$vy = function () {
  return this.vy;
};
Ball.prototype.set$vy = function (value) {
  return (this.vy = value);
};
Ball.prototype.get$radius = function () {
  return this.radius;
};
Ball.prototype.set$radius = function (value) {
  return (this.radius = value);
};
Ball.prototype.get$rotation = function () {
  return this.rotation;
};
Ball.prototype.set$rotation = function (value) {
  return (this.rotation = value);
};
Ball.prototype.get$lineWidth = function () {
  return this.lineWidth;
};
Ball.prototype.set$lineWidth = function (value) {
...
function Line() {}
Line.prototype.get$x = function () {
  return this.x;
};
Line.prototype.set$x = function (value) {
  return (this.x = value);
};
Line.prototype.get$y = function () {
  return this.y;
};
Line.prototype.set$y = function (value) {
  return (this.y = value);
};
Line.prototype.get$rotation = function () {
  return this.rotation;
};
Line.prototype.set$rotation = function (value) {
  return (this.rotation = value);
};
Line.prototype.get$lineWidth = function () {
  return this.lineWidth;
};
Line.prototype.set$lineWidth = function (value) {
  return (this.lineWidth = value);
};
...
Line.prototype.getBounds = function () {
  ...
  if (($0 = this.rotation) == null ? null == 0 : $0 === 0) {
    ...
    var sin = Math.sin(this.rotation),
      ...
      x1r = $mul(cos, this.x1) + $mul(sin, this.y1),
      x2r = $mul(cos, this.x2) + $mul(sin, this.y2),
      y1r = $mul(cos, this.y1) + $mul(sin, this.x1),
      y2r = $mul(cos, this.y2) + $mul(sin, this.x2);
    return new localBound(
...
(function () {
  ...
  var v1 /*SVGTextPositioningElement*/ =
