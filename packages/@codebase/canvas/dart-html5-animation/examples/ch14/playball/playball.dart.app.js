...
playball.prototype.run = function () {
  ...
  function checkHit() {
    var segment = segments.$index(0),
      dx = $sub(segment.getPin().get$x(), ball.get$x()),
      dy = $sub(segment.getPin().get$y(), ball.get$y()),
...
point.prototype.get$radius = function () {
  return this.radius;
};
point.prototype.set$radius = function (value) {
