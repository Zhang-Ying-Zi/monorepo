...
followmouse2.prototype.run = function () {
  ...
  function drawFrame(t) {
    ...
    var dx = $sub(mouse.get$x(), arrow.get$x()),
      dy = $sub(mouse.get$y(), arrow.get$y()),
      angle = Math.atan2(dy, dx),
      ax = $mul(Math.cos(angle), force),
      ay = $mul(Math.sin(angle), force);
...
Arrow.prototype.get$x = function () {
  return this.x;
};
Arrow.prototype.set$x = function (value) {
  return (this.x = value);
};
Arrow.prototype.get$y = function () {
  return this.y;
};
Arrow.prototype.set$y = function (value) {
  return (this.y = value);
};
Arrow.prototype.get$rotation = function () {
  return this.rotation;
};
Arrow.prototype.set$rotation = function (value) {
