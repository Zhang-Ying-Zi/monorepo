...
$dynamic("drawImage$5").CanvasRenderingContext2D = function (
  $0,
  $1,
  $2,
  $3,
...
ElementWrappingImplementation.ElementWrappingImplementation$tag$factory =
  function (tag) {
...
CanvasElementWrappingImplementation.prototype.is$CanvasElement = function () {
  return true;
};
...
CanvasRenderingContext2DWrappingImplementation.prototype.drawImage = function (
  canvas_OR_image,
  sx_OR_x,
  sy_OR_y,
  sw_OR_width,
      ...
      if (null == height_OR_sh) {
        if (null == dx) {
          if (null == dy) {
            if (null == dw) {
              if (null == dh) {
                this._ptr.drawImage$3(
                  LevelDom.unwrapMaybePrimitive(canvas_OR_image),
                  sx_OR_x,
                  sy_OR_y
                );
                return;
...
CanvasRenderingContext2DWrappingImplementation.prototype.drawImage$3 =
  CanvasRenderingContext2DWrappingImplementation.prototype.drawImage;
CanvasRenderingContext2DWrappingImplementation.prototype.drawImage$5 =
  CanvasRenderingContext2DWrappingImplementation.prototype.drawImage;
...
ImageElementWrappingImplementation.prototype.is$ImageElement = function () {
  return true;
};
...
SelectElementWrappingImplementation.prototype.add$2 =
  SelectElementWrappingImplementation.prototype.add;
