...
CanvasGradientWrappingImplementation._wrap$ctor.prototype =
  CanvasGradientWrappingImplementation.prototype;
function CanvasGradientWrappingImplementation() {}
CanvasGradientWrappingImplementation.prototype.addColorStop = function (
  offset,
  color
) {
...
CanvasRenderingContext2DWrappingImplementation.prototype.createRadialGradient =
  function (x0, y0, r0, x1, y1, r1) {
    return LevelDom.wrapCanvasGradient(
      this._ptr.createRadialGradient(x0, y0, r0, x1, y1, r1)
    );
  };
...
LevelDom.wrapCanvasGradient = function (raw) {
  return null == raw
    ...
    : new CanvasGradientWrappingImplementation._wrap$ctor(raw);
};
