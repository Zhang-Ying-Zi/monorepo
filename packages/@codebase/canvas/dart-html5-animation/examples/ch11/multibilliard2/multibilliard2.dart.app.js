...
multibilliard2.prototype.run = function () {
  ...
  var numBalls = 15,
    bounce = -1;
  for (var radius, ball, i = 0; $lt(i, numBalls); i = $add(i, 1)) {
  ...
  function checkCollision(ball0, ball1) {
    ...
    if ($lt(dist, ball0.get$radius() + ball1.get$radius())) {
      var angle = Math.atan2(dy, dx),
        ...
        vxTotal = $sub(vel0.get$x(), vel1.get$x());
      vel0.set$x(
        ($mul(ball0.get$mass() - ball1.get$mass(), vel0.get$x()) +
          $mul(2 * ball1.get$mass(), vel1.get$x())) /
          (ball0.get$mass() + ball1.get$mass())
      );
