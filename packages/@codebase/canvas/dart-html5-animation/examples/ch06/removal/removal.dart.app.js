...
$dynamic("removeRange").CanvasPixelArray = function (start, length) {
  $throw(
    new UnsupportedOperationException("Cannot removeRange on immutable List.")
  );
};
...
Ball.prototype.get$id = function () {
  return this.id;
};
Ball.prototype.set$id = function (value) {
...
(function () {
  ...
  var v7 /*Node*/ = [
    ...
    v3 /*HTMLElement*/,
    v4 /*SVGElement*/,
    "Node|Attr|CharacterData|Comment|Text|CDATASection|DocumentFragment|DocumentType|Element|Entity|EntityReference|Notation|ProcessingInstruction",
  ].join("|");
  var table = [
