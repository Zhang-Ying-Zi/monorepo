...
shipsim.prototype.run = function () {
  ...
  function drawFrame(t) {
    ...
    var angle = ship.get$rotation(),
      ax = $mul(Math.cos(angle), thrust),
      ay = $mul(Math.sin(angle), thrust),
      left = 0,
...
Ship.prototype.get$x = function () {
  return this.x;
};
Ship.prototype.set$x = function (value) {
  return (this.x = value);
};
Ship.prototype.get$y = function () {
  return this.y;
};
Ship.prototype.set$y = function (value) {
  return (this.y = value);
};
Ship.prototype.get$width = function () {
  return this.width;
};
Ship.prototype.set$width = function (value) {
  return (this.width = value);
};
Ship.prototype.get$height = function () {
  return this.height;
};
Ship.prototype.set$height = function (value) {
  return (this.height = value);
};
Ship.prototype.get$rotation = function () {
  return this.rotation;
};
Ship.prototype.set$rotation = function (value) {
  return (this.rotation = value);
};
Ship.prototype.get$showFlame = function () {
  return this.showFlame;
};
Ship.prototype.set$showFlame = function (value) {
  return (this.showFlame = value);
};
