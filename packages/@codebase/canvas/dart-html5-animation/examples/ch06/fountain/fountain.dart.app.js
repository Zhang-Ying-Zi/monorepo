...
fountain.prototype.run = function () {
  ...
  function draw(ball) {
    ...
    if (
      $sub(ball.get$x(), ball.get$radius()) > canvas.get$width() ||
      $lt($add(ball.get$x(), ball.get$radius()), 0) ||
      $sub(ball.get$y(), ball.get$radius()) > canvas.get$height() ||
      $lt($add(ball.get$y(), ball.get$radius()), 0)
    ) {
      ball.set$x(canvas.get$width() / 2);
      ball.set$y(canvas.get$height());
      ball.set$vx(Math.random() * 2 - 1);
