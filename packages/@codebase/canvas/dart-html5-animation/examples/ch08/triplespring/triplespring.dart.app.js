...
triplespring.prototype.run = function () {
  ...
  var ball0 = new Ball.withRadius$ctor(20),
    ball1 = new Ball.withRadius$ctor(20),
    ball2 = new Ball.withRadius$ctor(20),
  ...
  canvas
    ...
    .add(function (event) {
      if (
        Utils.containsPoint(ball0.getBounds(), mouse.get$x(), mouse.get$y())
      ) {
        ball0_dragging = true;
      }
      if (
        Utils.containsPoint(ball1.getBounds(), mouse.get$x(), mouse.get$y())
      ) {
        ball1_dragging = true;
      }
      if (
        Utils.containsPoint(ball2.getBounds(), mouse.get$x(), mouse.get$y())
      ) {
        ball2_dragging = true;
      }
    }, false);
  ...
  function springTo(ballA, ballB) {
    var dx = $sub(ballB.get$x(), ballA.get$x()),
      dy = $sub(ballB.get$y(), ballA.get$y()),
      angle = Math.atan2(dy, dx),
      targetX = $sub(ballB.get$x(), $mul(Math.cos(angle), springLength)),
      targetY = $sub(ballB.get$y(), $mul(Math.sin(angle), springLength));
...
Bound.prototype.get$x = function () {
  return this.x;
};
Bound.prototype.set$x = function (value) {
  return (this.x = value);
};
Bound.prototype.get$y = function () {
  return this.y;
};
Bound.prototype.set$y = function (value) {
  return (this.y = value);
};
Bound.prototype.get$width = function () {
  return this.width;
};
Bound.prototype.set$width = function (value) {
  return (this.width = value);
};
Bound.prototype.get$height = function () {
  return this.height;
};
Bound.prototype.set$height = function (value) {
