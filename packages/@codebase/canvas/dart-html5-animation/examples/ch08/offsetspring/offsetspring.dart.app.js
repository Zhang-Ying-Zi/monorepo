...
offsetspring.prototype.run = function () {
  ...
  function drawFrame(t) {
    ...
    var dx = $sub(ball.get$x(), mouse.get$x()),
      dy = $sub(ball.get$y(), mouse.get$y()),
      angle = Math.atan2(dy, dx),
      targetX = $add(mouse.get$x(), $mul(Math.cos(angle), springLength)),
      targetY = $add(mouse.get$y(), $mul(Math.sin(angle), springLength));
