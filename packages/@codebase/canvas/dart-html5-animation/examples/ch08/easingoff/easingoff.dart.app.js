...
WindowWrappingImplementation.prototype.webkitCancelRequestAnimationFrame =
  function (id) {
...
easingoff.prototype.run = function () {
  ...
  function drawFrame(t) {
    var animRequest = html_get$document()
      .get$window()
    ...
    if (dx.abs() < 1) {
      ...
      html_get$document()
        .get$window()
        .webkitCancelRequestAnimationFrame(animRequest);
