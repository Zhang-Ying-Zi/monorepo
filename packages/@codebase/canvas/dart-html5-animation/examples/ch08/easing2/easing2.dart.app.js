...
easing2.prototype.run = function () {
  ...
  var ball = new Ball();
  var easing = 0.05,
    targetX = canvas.get$width() / 2,
    targetY = canvas.get$height() / 2,
    isMouseDown = false;
  ...
  function drawFrame(t) {
    ...
    if (!isMouseDown) {
      var vx = $mul($sub(targetX, ball.get$x()), easing),
        vy = $mul($sub(targetY, ball.get$y()), easing);
