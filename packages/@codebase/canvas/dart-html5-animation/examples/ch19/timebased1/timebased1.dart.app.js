...
DateImplementation.prototype.get$year = function () {
  return this.isUtc
    ? this._asJs().getUTCFullYear()
    : this._asJs().getFullYear();
};
DateImplementation.prototype.get$month = function () {
  return this.isUtc ? this._asJs().getMonth() + 1 : this._asJs().getMonth() + 1;
};
...
timebased1.prototype.run = function () {
  ...
  var ball = new Ball(),
    start_time = new DateImplementation.now$ctor().value,
    vx = 300,
    vy = -300,
    bounce = -0.7;
