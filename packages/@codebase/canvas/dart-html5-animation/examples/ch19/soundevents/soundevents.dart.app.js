...
MediaElementWrappingImplementation.prototype.is$MediaElement = function () {
  return true;
};
...
AudioElementWrappingImplementation.prototype.is$MediaElement = function () {
  return true;
};
...
VideoElementWrappingImplementation.prototype.is$MediaElement = function () {
  return true;
};
...
soundevents.prototype.run = function () {
  ...
  if (
    !(
      !!(sound && sound.is$MediaElement()) &&
      sound.canPlayType("audio/ogg").endsWith("maybe")
    )
  ) {
    $throw(
      new ExceptionImplementation(
        "The audio element is not supported in this browser."
      )
    );
  }
