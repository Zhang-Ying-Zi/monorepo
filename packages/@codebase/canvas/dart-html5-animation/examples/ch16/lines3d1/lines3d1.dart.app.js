...
lines3d1.prototype.run = function () {
  ...
  var balls = [],
    ...
    angleX = 0,
    angleY = 0;
  for (var ball, i = 0; $lt(i, numBalls); i = $add(i, 1)) {
  ...
  function rotateX(ball, angle) {
    var cos = Math.cos(angle),
      sin = Math.sin(angle),
      y1 = $mul(ball.get$ypos(), cos) - $mul(ball.get$zpos(), sin),
      z1 = $mul(ball.get$zpos(), cos) + $mul(ball.get$ypos(), sin);
    ball.set$ypos(y1);
    ball.set$zpos(z1);
  }
  function rotateY(ball, angle) {
    var cos = Math.cos(angle),
      sin = Math.sin(angle),
      x1 = $mul(ball.get$xpos(), cos) - $mul(ball.get$zpos(), sin),
      z1 = $mul(ball.get$zpos(), cos) + $mul(ball.get$xpos(), sin);
    ball.set$xpos(x1);
    ball.set$zpos(z1);
  }
...
function Ball3d() {}
Ball3d.prototype.get$x = function () {
  return this.x;
};
Ball3d.prototype.set$x = function (value) {
  return (this.x = value);
};
Ball3d.prototype.get$y = function () {
  return this.y;
};
Ball3d.prototype.set$y = function (value) {
  return (this.y = value);
};
Ball3d.prototype.get$xpos = function () {
  return this.xpos;
};
Ball3d.prototype.set$xpos = function (value) {
  return (this.xpos = value);
};
Ball3d.prototype.get$ypos = function () {
  return this.ypos;
};
Ball3d.prototype.set$ypos = function (value) {
  return (this.ypos = value);
};
Ball3d.prototype.get$zpos = function () {
  return this.zpos;
};
Ball3d.prototype.set$zpos = function (value) {
  return (this.zpos = value);
};
Ball3d.prototype.get$scaleX = function () {
  return this.scaleX;
};
Ball3d.prototype.set$scaleX = function (value) {
  return (this.scaleX = value);
};
Ball3d.prototype.get$scaleY = function () {
  return this.scaleY;
};
Ball3d.prototype.set$scaleY = function (value) {
  return (this.scaleY = value);
};
Ball3d.prototype.get$lineWidth = function () {
  return this.lineWidth;
};
Ball3d.prototype.set$lineWidth = function (value) {
  return (this.lineWidth = value);
};
Ball3d.prototype.get$visible = function () {
  return this.visible;
};
Ball3d.prototype.set$visible = function (value) {
