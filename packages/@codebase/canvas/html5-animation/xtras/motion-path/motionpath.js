 ...
 * @return {MotionPath}     The current motion path instance.
 */
MotionPath.prototype.bezierCurveTo = function (
  control1,
  control2,
  end,
  strength
...
BezierPath.prototype.interpolate = function (start, t) {
  return (
    ...
    3 * Math.pow(1 - t, 2) * t * this.control1 +
    3 * Math.pow(1 - t, 1) * Math.pow(t, 2) * this.control2 +
    Math.pow(t, 3) * this.end
  );
};
