...
function resolve(schema, data, options = {}) {
  ...
  const value = typeof data === "undefined" ? getDefaultValue(schema) : clone(data);
...
export { resolve, getSubSchemas, clone, getValidateList, validate, evaluateString, convertValue };
