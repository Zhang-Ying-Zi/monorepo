<template>
  <a-spin :spinning="creating" tip="Loading...">
    ...
    <div class="index-wrapper">
      <a-card :key="item.id" v-for="item in templateList" hoverable style="width: 240px" @click="() => initPage(item)">
        <template #cover>
      ...
      <a-form-item label="活动域名" v-bind="validateInfos.gitName">
        <a-input-group compact>
          <a-select v-model:value="host">
            <a-select-option value="https://coco-h5.github.io/"> https://coco-h5.github.io/ </a-select-option>
          </a-select>
          <a-input placeholder="路径" style="width: 95px" v-model:value="gitName" />
