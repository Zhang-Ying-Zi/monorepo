(function () {
  ...
  function addJSIndent(file, t) {
    ...
    if (
      filename === "wrap-start.js" ||
      filename === "wrap-end.js" ||
      filename === "dom7/dom7.js" ||
      filename === "template7/template7.js"
    ) {
      addIndent = "";
    }
    var add4spaces =
      "framework7/f7-intro.js framework7/f7-outro.js framework7/proto-device.js framework7/proto-plugins.js framework7/proto-support.js swiper/swiper.js".split(
        " "
      );
  ...
  gulp.task("dom7", function (cb) {
    rollup({
      ...
      .on("end", function () {
        ...
        fs.writeFileSync(
          "./src/js/dom7/dom7.js",
          fileContent.replace("var Dom7 = (function () {", "window.Dom7 = (function () {")
        );
        cb();
      });
  });
  gulp.task("template7", function (cb) {
    rollup({
      ...
      .on("end", function () {
        ...
        fs.writeFileSync(
          "./src/js/template7/template7.js",
          fileContent.replace("var Template7 = (function () {", "window.Template7 = (function () {")
        );
        cb();
      });
  });
  ...
  gulp.task("styles-ios", function (cb) {
    var cbs = 0;
    ["framework7.ios.less", "framework7.ios.rtl.less", "framework7.ios.colors.less"].forEach(function (
      lessFilePath,
      b
    ) {
  ...
  gulp.task("styles-material", function (cb) {
    var cbs = 0;
    ["framework7.material.less", "framework7.material.rtl.less", "framework7.material.colors.less"].forEach(function (
      lessFilePath,
      b
    ) {
  ...
  gulp.task("demo-app", function (cb) {
    gulp
      .src(paths.source.root + "templates/*.jade")
      .pipe(
        jade({
          pretty: true,
          locals: {
    ...
    gulp.src(paths.source.root + "my-app/my-app.js").pipe(gulp.dest(paths.build.scripts));

    gulp.src(paths.source.root + "my-app/my-app.css").pipe(gulp.dest(paths.build.styles));

    gulp
      .src(paths.source.root + "img/*.*")
  ...
  gulp.task("dist", function () {
    gulp
      ...
      .on("end", function () {
        ...
        // Minify JS
        gulp
          .src([paths.dist.scripts + f7.filename + ".js"])
          .pipe(sourcemaps.init())
          .pipe(uglify())
          .pipe(header(f7.banner, { pkg: f7.pkg, date: f7.date }))
          .pipe(
  ...
  gulp.task("watch", function () {
    ...
    // Demo App
    gulp.watch(
      [paths.source.root + "templates/*.jade", paths.source.root + "my-app/*.*", paths.source.root + "img/*.*"],
      ["demo-app"]
    );
    ...
    gulp.watch(paths.ks.ios.root + "js/*.js", function () {
      gulp.src(paths.ks.ios.root).pipe(connect.reload());
    });
    // KS Material
    ...
    gulp.watch(paths.ks.material.root + "js/*.js", function () {
      gulp.src(paths.ks.material.root).pipe(connect.reload());
    });
    // Examples
    var i;
    for (i = 0; i < paths.examples.list.length; i++) {
      ...
      gulp.watch([exampleRoot + "jade/*.jade", exampleRoot + "less/*.less"], ["examples"], function () {
        gulp.src([exampleRoot + "jade/*.jade", exampleRoot + "less/*.less"]).pipe(connect.reload());
      });
    }
  });
